...
// MERGE ALL BAD END FUNCTIONS TOGETHER
...
SandWitchScene.beatSandWitch = function() {
    if (monster.lust >= monster.maxLust()) outputText("You smile in satisfaction as the " + monster.name + " drops down on all fours and begins masturbating feverishly.  Sadly you realize your own needs have not been met.  Of course you could always fuck the horny witch...\n\nDo you rape her?", true);
...
// CODE TO ADD ONCE OVIPOSITING IS FULLY WORKING!

// Placeholder for now

SandWitchScene.ovipositSandWitches = function() {
    outputText("Ovipositing not fully functional. Returning to camp");
    doNext(Camp.returnToCampUseOneHour);
}
