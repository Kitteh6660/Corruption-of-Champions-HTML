...
function SandWitch() {
    ...
    this.fatigue = 0;
    this.temperment = 3; //TEMPERMENT_LUSTY_GRAPPLES
    //Advancement
    this.level = 3;
    this.gems = 5 + rand(15);
    //Battle variables
    ...
    //Victory/defeat
    this.victory = SandWitchScene.win;
    this.defeat = SandWitchScene.lose;
}
...
// COMPLETE WHEN EXGARTUAN IS CODED
SandWitchScene.encounter = function() { 
    ...
    if (gameFlags[CODEX_ENTRY_SANDWITCHES] <= 0) {
        ...
        outputText("<br><br><b>New codex entry unlocked: Sand Witches!</b><br><br>");
    }
    /*if (player.statusEffectValue(StatusEffects.Exgartuan, 1) == 1 && player.cockArea(0) > 100 && player.statusAffectv2(StatusAffects.Exgartuan) == 0) {
        outputText("<br><br>The " + player.armorName + " covering your lower half hits the ground, as if yanked down by magic.  Your " + cockDescript(0) + " pulsates darkly, growing rigid in seconds as the demon within you takes over.  It barks, \"<i>Fuck, how about I cast my spell on you baby?</i>\"<br><br>");
...
SandWitchScene.allowSandWitchMagic = function() {
    ...
    if (player.hairColor == "sandy blonde") {
        ...
        outputText("She smiles wickedly and intones, \"<i>nuf erutuf rof riah ydnas, nus tresed eht sa ydnas.</i>\"<br><br>You feel a tingling in your scalp, and realize your hair has become a sandy blonde!");
...
// LOSE AGAINST SAND WITCH

//NEED TO MAKE WORM CHECK FUNCTION IN Creature/Player
SandWitchScene.lose = function() {

    //if (pcCameWorms){
      //  outputText("<br><br>The witch blanches and backs away, leaving you to your fate.");
       // cleanupAfterCombat();
    //}
    //else {
...
SandWitchScene.sandWitchRape = function() {
    //spriteSelect(50);
    ...
    if (player.lust >= player.maxLust()) {
        ...
        if (player.biggestTitSize() >= 9 && player.biggestLactation() >= 3 && player.cor >= 25) {
            outputText("Overwhelmed by the intense pleasure caused by the vibrating sphere inside your body, you fall to your knees.<br><br>You whimper pathetically, desperate to cum, as the Sand Witch steps nearer to you and gently strokes your face. She smiles cruelly and lets her hands drop down to your chest, then tears your top away, letting your huge breasts bounce free. The mysterious woman firmly rubs and kneads them, making you gasp and writhe, until she starts lightly flicking your painfully hard nipples. You edge closer and closer to orgasm, panting like a whore while the witch teases you with her hands and magic.<br><br>", true);
            outputText("Just before you cum, she leans down to whisper to you, tickling your ear with her warm breath: \"<i>Evals klim ym emoceb llahs uoy.</i>\"<br><br>A familiar pressure builds in your chest, but it's far stronger than ever before. You feel your breasts swell rapidly, and milk sprays from your nipples, splattering you and the witch with white droplets. Your eyes roll back and your tongue hangs out as you cum, mind nearly breaking from the world-shattering orgasm that thunders through you.<br><br>You black out.", false);
            doNext(SandWitchScene.sandWitchBadEnd);
            return;
        }
        // USUAL DEFEAT
        outputText("Your wobbly legs give out underneath you as your body's will to fight evaporates.<br><br>", true);
        if (player.hairColor.indexOf("sandy blonde") != -1) {
            outputText("The Sand Witch smiles wickedly and intones, \"<i>Tresed eht retaw llahs klim ruoy.</i>\"<br><br>", false);
            if (player.breastRows.length == 0 || player.biggestTitSize() == 0) {
            ...
            if (player.biggestLactation() > 0) {
                ...
                player.dynStats("lib", 1, "sen", 4, "lus", 15);
            }
            if (player.biggestLactation() == 0) {
    ...
    //HP DEFEAT
        ...
        // CHECK FOR BAD END
        if (player.biggestTitSize() >= 9 && player.biggestLactation() >= 3 && player.cor >= 25) {
            outputText("You stagger and fall to one knee, too overcome by pain to keep fighting.<br><br>As your vision wavers with exhaustion, the witch strides towards you, seeming to glide across the sand. Your consciousness starts to fade, and you see the exotic woman lick her lips and smile cruelly, staring at your generous breasts.<br><br>The last thing you hear before passing out is a mysterious spell, murmured right into your ear in a low, throaty whisper: \"<i>Evals klim ym emoceb llahs uoy.</i>\"<br><br>You dream of walking proudly through the desert, enormous rack jiggling shamelessly with every step, and of tempting nubile young champions to wrap their lips around your nipples and drink. Your sleep becomes fevered as your dreams grow more and more corrupt - you dream of using dark magic to lactate succubus milk, and of your former friends from Ingnam greedily drinking your enhanced milk until their bellies strain to contain it all, then going wide-eyed as pound after pound of breast-flesh suddenly swells upon their chests...", true);
            //BAD END.
            doNext(SandWitchScene.sandWitchBadEnd);
            return;
        }
        outputText("<br><b>You fall, defeated by the Sand Witch!</b><br><br>", false);
        cleanupAfterCombat();
        player.orgasm();
    }
...
// MERGED ALL BAD END FUNCTIONS TOGETHER
SandWitchScene.sandWitchBadEnd = function() {
   clearOutput();
    ...
    outputText("\"<i>Hello, my beautiful pet,</i>\" says a familiar voice. Looking to your front – and trying not to notice the vast expanse of cleavage that dominates the lower half of your vision – you see the Sand Witch sitting, nude, in a large granite basin set into the floor just in front of you. She smirks when she sees how your eyes avoid resting on your obscenely massive bust.<br><br>");
    outputText("\"<i>What's wrong? Don't you like them?</i>\" The witch leans toward you and roughly tugs on one huge nipple, causing you to yelp with surprise and pleasure. \"<i>I'm afraid that's too bad. You offered yourself to me, and now you are mine, all mine, forever.</i>\" She slowly rubs her hands over your colossal bosom, crooning with approval as you squirm and bite your lip. \"<i>Mmm, yes... first, you will give me a bath.</i>\"<br><br>You hardly have time to wonder what she means before a familiar, hugely intense pressure builds in your chest...<br><br>");
   outputText("With an audible gurgling noise, your breasts begin to fill with prodigious quantities of milk. Your eyes widen in amazement when you feel your tits swelling, filling, pumping up to their limits. It feels shockingly pleasurable and somehow almost right, like you were meant to have these shamefully huge, milk-filled titties. As you watch the soft flesh stretch taut, your breasts fatten into a very round shape beneath you, and the pleasurable sensation becomes a painful feeling of urgency.<br><br>");
   ...
   outputText("Something breaks within your soul, accompanied by a strangled sob. Tears of humiliation trickle down your face as you part your quivering lips. \"<i>Please milk me, Mistress. Your slave needs to be milked.</i>\"<br><br>");
...
//ADD ADDITIONAL SCENES WHEN SHOULDRA IS CODED AND TAMANI DILDO IS CODED
SandWitchScene.beatSandWitch = function() {
    if (monster.lust >= monster.maxLust()) outputText("You smile in satisfaction as the " + monster.name + " drops down on all fours and begins masturbating feverishly.  Sadly you realize your own needs have not been met.  Of course you could always fuck the horny witch...<br><br>Do you rape her?", true);
    else outputText("You smile in satisfaction as the " + monster.name + " drops down on all fours and struggles to rise.  Sadly you realize your own needs have not been met.  Of course, you could always fuck the witch...", true);
    ...
    menu();
    addButton(0, "Fuck Witch", SandWitchScene.sandWitchRaped, null, null, null, "TO BE ADDED");
    //if (player.hasKeyItem(KeyItems.   ) >= 0) {
    //    addButton(1, "Dildo Rape", SandWitchScene.sandWitchGetsDildoed, null, null, null, "TO BE ADDED");
    //}
    if (silly == true) {
        addButton(2, "Use 3i@-", SandWitchScene.missingOSex, null, null, null, "TO BE ADDED");
    }
    // Button 3
    ...
    if (player.gender > 0 && player.canOviposit()) {
        addButton(4, "Lay Eggs", SandWitchScene.ovipositSandWitches, null, null, null, "TO BE ADDED");
    }
    addButton(5, "Taunt Her", SandWitchScene.sandWitchSpanking, null, null, null, "TO BE ADDED");
    addButton(6, "Leave", cleanupAfterCombat, null, null, null, "TO BE ADDED");
};

// Rape Scene Selector

SandWitchScene.sandWitchRaped = function() {
    //spriteSelect(50);
    clearOutput();
    if (player.isTaur()) {
    //    doNext(camp.returnToCampUseOneHour);
        SandWitchScene.sandWitchCentaurBoning();
    ...
    if (player.gender == 1 || player.gender == 3) {
        ...
        if (player.cor < 50) {
            ...
            outputText("Your attention wanders down to the damp sand underneath her legs, and her musky scent hits your nose. Which do you go after?<br><br>", false);
            menu();
            addButton(0, "Breasts", SandWitchScene.sandWitchBewbs, null, null, null, "TO BE ADDED");
            addButton(1, "Sex", SandWitchScene.sandWitchSex, null, null, null, "TO BE ADDED");
            return;
        }
        //Really corrupt
        else
        {
            ...
            if (player.cockTotal() == 1) {
                //DOGGIES
                if (player.dogCocks() > 0 && player.cocks[0].knotMultiplier > 1.4) SandWitchScene.knotSandWitch();
                else {
            ...
            if (player.cockTotal() > 1) {
                if (rand(2) == 0) {
                    SandWitchScene.rapeSandWitchMultis();
                    return;
                }
    ...
    //Femfem
        ...
        outputText("You smile at the sand witch, trying to seem enticing. A tiny smile plays across her face even though she supports a worried frown. She reaches up to you, and you allow her to gently pull you down to her. You marvel at her multiple breasts, each perfectly rounded. Each has a nipple approximately two inches long, enough to suck if you wanted to.  ", false);
        outputText("Your attention wanders down to the damp sand underneath her legs, and her musky scent hits your nose.<br><br>", false);
        SandWitchScene.sandWitchBewbs();
    }
};
...
SandWitchScene.sandWitchCentaurBoning = function() {
    //spriteSelect(50);
    //player.orgasm();
    ...
    //[Corruption > 70]
        ...
        //[% no cocks]
            ...
            SandWitchScene.SWCentaurMore(1);
            cleanupAfterCombat();
            player.orgasm();
            doNext(Camp.returnToCampUseTwoHours);
...
// Taur rape results function
SandWitchScene.SWCentaurMore = function() {
            //spriteSelect(50);
            //{ GoTo results }}
            // Results of Witch Spell during Player Rape
                ...
                //Grow tits
                if (player.biggestTitSize() == 0) {
                    outputText("<br><br>(You grow a perfectly rounded pair of C-cup breasts!)", false);
                    if (player.breastRows.length == 0) player.createBreastRow();
                    player.breastRows[0].breasts = 2;
                    player.breastRows[0].breastRating = 3;
                    if (player.breastRows[0].nipplesPerBreast < 1) player.breastRows[0].nipplesPerBreast = 1;
                ...
                //Grow tits bigger
                if (player.biggestTitSize() < 3) {
                    outputText("<br><br>(Your breasts suddenly balloon outwards, stopping as they reach a perfectly rounded C-cup.)", false);
                    player.breastRows[0].breastRating = 3;
                    player.dynStats("sen", 1, "lus", 1);
                    return;
                }
                if (player.biggestLactation() == 0) {
                    outputText("<br><br>(Your breasts now lactate.)", false);
                    player.boostLactation(1);
                    player.dynStats("lib", .5, "sen", 1, "lus", 10);
                    return;
                }
                ...
                if (player.biggestLactation() < 3) {
                    player.boostLactation(.7);
                    outputText("<br><br>(Your breasts feel fuller... riper... milkier...)", false);
                    return;
                }
                //Libido boost if nothing else
                player.dynStats("lib", 4);
                outputText("<br><br>(Your libido has been boosted significantly by the Sand Witch's magic.)", false);
                return;

};

// Sand Witch Breast Scene

SandWitchScene.sandWitchBewbs = function() {
    //spriteSelect(50);
    clearOutput();
...
// Standard Male Sex Scene with Sand Witch

SandWitchScene.sandWitchSex = function() {
    //spriteSelect(50);
    clearOutput();
    ...
    outputText("<br><br>With a satisfied smirk, you lay atop your prize, your " + player.cockDescript(0) + " still twitching within her depths. One of the sand witch's hands rubs at your head, teasing your " + player.skinDesc + ". Like a fresh youth, you fall asleep, " + player.cockDescript(0) + " buried deep in the sand witch.  ", false);
...
SandWitchScene.knotSandWitch = function() {
    ...
    outputText("You begin to buck into her at a frenzied pace, your body's need to release your motivation.  At first, your knot swelling is an extra sensation, a tightness that squeezes deliciously as more and more blood is forced inside by sheer stimulation.<br><br>", false);
    ...
    outputText("You grunt and push hard, desperate to force the bulbous cock-flesh inside, and you're rewarded as it pops in with a wet squelch. The tightening pressure around the base of your " + player.cockDescript(0) + " pushes you over the edge, and the cum begins to shoot in her tight hole, with your " + player.cockDescript(0) + " trapped inside!<br><br>", false);
//ORGAZMO
...
SandWitchScene.missingOSex5 = function() {
    ...
    menu();
    addButton(0, "Restore", SandWitchScene.missingOSex6);

}
//{Next Page}
SandWitchScene.missingOSex6 = function() {
    //spriteSelect(50);
clearOutput();
outputText("You successfully restore your game. Everything's intact. At least, you thought it was. You must have messed up the password somewhere along the line, but oddly enough, the only difference is the clock being set an hour ahead and a few extra gems and EXP in your pocket.<br><br>", false);
...
// Sandwitch Spanking Scene

SandWitchScene.sandWitchSpanking = function() {
    clearOutput();
    ...
    outputText("<br><br>The smirking sorceress laughs, \"<i>You are too prideful for your own good.  Now, I will teach you respect for our order, one spank at a time.</i>\"  She doesn't even wait before hitting you again, bringing her hand down on your unprotected ass without hesitation.  You squirm from pain, trying to escape, to wiggle free, but there's no use - you're tied down with stone restraints that you can't hope to escape.  All you can do is writhe uselessly against your bindings while your [butt] is tanned bright red, tingling with residual pain even when it isn't being hit.");
    outputText("<br><br>This seems to last forever, and after what feels like hours of pain, you begin to beg for it to stop, whining and whimpering.  As soon as your voice takes on a genuine note of repentance, the blows stop falling.  The witch, having worked her frustrations out of her system, says, \"<i>That is acceptable.  Now, I shall leave you to think on your sins.  Let the sun's baleful gaze bake away the pain and replace it with discipline.</i>\"  ");
    ...
    outputText("<br><br>Picking up the pieces of her tattered robe, the sand witch makes to leave.  She stops after a few paces and turns back your way, \"<i>Perhaps this will ease the wait.</i>\"  Your eyes widen in anger when she makes familiar motions, but there's nothing you can do.  Soon, smooth stone orbs are sliding into through your cheeks and into your [butt]");
    ...
    gameFlags[COMBAT_BONUS_XP_VALUE] = monster.XP;
    cleanupAfterCombat();
    player.orgasm();
...
//----------------
// Sand Witch Ovipositing Scene Code
//----------------



SandWitchScene.ovipositSandWitches = function() {
    clearOutput();
    ...
    if (monster.HP < 1) outputText("<br><br>Rolling your eyes, you offer a sympathetic hand to the defeated witch, showing her that you don't mean to hurt her any further, that you have something more... pleasurable in mind.  ")
    ...
    outputText("<br><br>Drawing closer to the prone woman, you can see her ardent lust accumulating on her tender sexes; yet you can clearly see the remnants of her wariness, no doubt having heard what ");
    ...
    menu();
    addButton(0, "Foreplay", SandWitchScene.eggWitchForeplay, null, null, null, "TO BE ADDED");
    addButton(1, "Get Fucking", SandWitchScene.getToFuckingWithZeEggsInWitch, null, null, null, "TO BE ADDED");
};

SandWitchScene.eggWitchForeplay = function() {
    clearOutput();
    ...
    outputText("<br><br>Grinning in delight at the desert vixen's willful submission, you oblige her desires and spread her thighs apart; the aroma and heat of her excitement rising to your nostrils is the perfect greeting and welcome for you.  With blood surging to your sex");
    ...
    outputText("<br><br>Having warmed this sorceress up ");
    ...
    player.dynStats("lus", 25, "cor", -.35);
    doNext(SandWitchScene.laySomeEggsInThatWitchFinally);
};

SandWitchScene.getToFuckingWithZeEggsInWitch = function() {
    clearOutput();
    ...
    if (player.cor < 66) {
        ...
        outputText("<br><br>Reluctantly, the sorceress spreads her legs to welcome you into her being.  Between the reciprocation of your caresses you work your alien appendage against her dripping sex, teasing and lathering her clits and anus with your 'special' lust.");
    }
    //[PC corruption is greater than 60:
        ...
        outputText("<br><br>Her labored breathing becomes ever more erratic as the bulbous mass of your ovipositor un-sheaths and presses against her lubricated sex, her whole body tensing up in horror at what is to come.");

        outputText("<br><br>But what would this serve, really? To force yourself on her?  You KNOW the tainted, wanton whore lies just beneath the surface of this woman's form; the whore that begs to be fucked and taken roughly by you.  All she needs is a little persuasion to admit she wants this, to have her accept the slut within.  The sand witch shivers as you whisper into her ear that you know she hungers for your other-worldly appendage in her pussy; that the facade of being apprehensive about this is but an illusion to deny her very nature.  You know deep down she wants nothing more than to lie back and join with you in carnal bliss; and you can make that happen - she just needs to <i>admit it</i>, to stop lying to herself.  Heavy, ponderous breathing and a twitch of the eyes is your response, the sand witch struggling to find meaning in what you say.");

        outputText("<br><br>\"<i>No... I...</i>\" the sand witch tries to protest, but her arousal at the sight of your ovipositor gives away the smokescreen she's been putting up.  You bring the final blow to bear as you tell her that there is no shame in admitting her lusts, but there is shame in denying what she's become, in denying what she craves.  The weight of your words seems to lift the world from the woman's shoulders, until she acknowledges the taint that has taken root in just about every living thing in this land.");

        outputText("<br><br>\"<i>Please... take me...</i>\"");
    }
    //both go to merge
...
// May need to modify this to differentiate between anal and vaginal birth code? Currently just implants vaginally in the code despite text.
SandWitchScene.laySomeEggsInThatWitchFinally = function() {
    clearOutput();
    var cunt = (rand(2) == 0);
    ...
    outputText("<br><br>\"<i>More... give me more...</i>\" the sand witch whimpers, caressing your ");
//(Bee, non-horse:
    ...
    outputText("<br><br>For what feels like an eternity you sit atop the pliant sorceress, having her tend to your sex");
    if (player.cockTotal() > 1 || player.gender == 3) outputText("es");
    ...
    // Sand Witch gets special incubation time for eggs!
    if (player.fertilizedEggs() > 0) {
        if (player.canOvipositBee()) {
            this.knockUpForce(PREGNANCY_BEE_EGGS, 192);
            this.eventFill(INCUBATION_SAND_WITCH_EVENT);
        }
        else {
            this.knockUpForce(PREGNANCY_DRIDER_EGGS, 192);
            this.eventFill(INCUBATION_SAND_WITCH_EVENT);
        }
    }
    player.dumpEggs();
...
SandWitchScene.sammitchBirthsDriders = function() {
    clearOutput();
    ...
    outputText("<br><br>\"<i>S-stay away!  I'm in no position to- it's you!  I never figured I would see you again before our little bundle of joy came into the world!</i>\" the weary sorceress admits, relieved to no end to see you.  You nod in greeting, staring at her swollen belly.");

    outputText("<br><br>\"<i>I tried to make it back to my coven but... nature had other plans...</i>\" she jokes weakly, before lurching over in obvious pain.  \"<i>...They're coming!  I can't make it somewhere proper to birth our children! Please, help me!</i>\"");

    outputText("<br><br>You can guess that without such help the babies she'll give birth to will wither and die in such a hostile climate.");

    //corr < 60 goes to Help her!, else go to Must I really?
    if (player.cor < 60) SandWitchScene.helpZeWithBirfBabies();
    else SandWitchScene.reluctantlyHelpZeWitch();
}

//[Help her!] (corr < 60)
//no new PG
SandWitchScene.helpZeWithBirfBabies = function() {
    outputText("<br><br>Filled with pride that you're going to be a 'father', you quickly rush to the sand witch's side and help her to her feet.  She can barely stand as it is, and groans intensely as she struggles to delay the birth of your children.");
...
//difference in your appearance since the union with wide eyes.  The words are cut off, however, as she doubles over in pain. (transitions to PC is a drider/centaur/whatever scene)
    if (!player.isDrider()) outputText("<br><br>\"<i>W-what the hell did you do to yourself over the last few days?</i>\" the sand witch blurts, noticing the difference in your appearance since your union.  The words that come out of her mouth next are cut off however, as she doubles over in pain.");

//PC is a drider/centaur/whatever:
    if (player.isTaur() || player.isDrider()) {
        outputText("<br><br>\"<i>I-I can't get up; it hurts too much!</i>\" she cries out, despairing of making it somewhere safe in time, and that your children will be born and die out here, all in the same day.  Sternly, you tell her to get on your lower half, sinking to the ground to allow her to hobble up.");

        outputText("<br><br>\"<i>Please, not too fast!</i>\" she calls out from behind you, clearly trying her best to not have the labors of your lust right here and now.  Rising to your [feet], you attempt to recall which way to go, only to realize that it doesn't matter.  Concentrating on the camp, you yell at the sand witch to hold on, then ");
        if (player.isDrider()) outputText("skitter");
        else outputText("gallop");
        outputText(" across the dry desert sea...");
    }
//PC is everything else:
    else outputText("<br><br>Easing a hand under her armpit, you give her the support she needs to hobble along the hot desert sand.  Which direction to hobble in gives you cause for concern though; you don't really know where you are at this point.  Making the only choice you can, you concentrate on the camp.  With the rough picture in mind you tell the sand witch to hold on, before the two of you slowly make your way across the dry desert sea...");
    doNext(SandWitchScene.sandWitchBirthsYourMonstrositites);
}

//[Must I really?] (corr >=60)
SandWitchScene.reluctantlyHelpZeWitch = function() {
    outputText("<br><br>Great.  Of all the things you could be doing, you get stuck helping this twit out.  Why she couldn't have just stayed home or gone to the swamp is beyond you at this point - you grumble at your misfortune, helping the bearer of your young to rise to her feet.");
...
//PC is a drider/centaur/whatever:
    if (player.isDrider() || player.isTaur()) {
        outputText("<br><br>\"<i>I-I can't get up, it hurts too much!</i>\" she cries out, despairing of making it somewhere safe it in time, and that your children will be born and die out here, all in the same day.  Annoyed at her lack of common sense, you tell her to get on your back, sinking to the ground to allow her to hobble up.");
        outputText("<br><br>\"<i>Please, not too fast!</i>\" she calls out, clearly trying her best to not have the labors of your lust right here and now.  You'll be goddamned furious if she ends up having the kids right here and now; it's a bear to clean parts of you when your arms can't reach them!  Rising to your feet, you attempt to recall which direction to go, only to realize that you're lost.  Even better- well, actually, it doesn't matter.  Concentrating on the camp, you yell at the sand witch to hold on, then ");
        if (player.isDrider()) outputText("skitter");
        else outputText("gallop");
        outputText(" across the dry desert sea...");
    }
...
SandWitchScene.sandWitchBirthsYourMonstrositites = function() {
    clearOutput();
    ...
    outputText("<br><br>Relieved to have finally carried the children to term, the sand witch lies back against the grass and smiles, jubilant that she was able to undergo such a joyous experience.  Humming her happiness to all those within earshot, she relishes this fleeting moment of motherhood as your young drink their fill and skitter shakily off, no doubt heading for the swamp.");

    outputText("<br><br>As you turn to the spellcaster, she shoots you a look of appreciation... even longing.  \"<i>Thank you.  Perhaps... we could try this again sometime?</i>\" she inquires, her voice filled with the hope that she'll see you again.");

    outputText("<br><br>You aren't ruling anything out; it's almost a guarantee that she will run into you one of these days... but perhaps she could just skip the whole spell casting bit next time?  The loud din of snoring cuts through the air in response and elicits a sigh from you.  No doubt her ordeal was exhausting.  You lean down and");
    if (player.cor < 60) outputText(", with a quick kiss on the lips");
    outputText(", whisper in her ear that you'll see her again...");

    //[(corr >= 60)
    if (player.cor >= 60) outputText("<br><br>\"<i>Just, use your common sense next time.</i>\"");
    SandWitch.knockUpForce(0,0); //Clear Pregnancy
    doNext(Camp.returnToCampUseOneHour);

};

SandWitchScene.witchBirfsSomeBees = function() {
    clearOutput();
    //Occurs 8 days (or moar appropriate time) after fertile oviposition; triggered when exploring the Desert
    ...
    outputText("<br><br>Rushing towards the crescendo of loud buzzing, you stumble upon the haughty sorceress lying in the sand, with the tell-tale aftermath of bee-brand oviposition pooled around her buttocks.  The swarm stays only for a few brief moments");
    ...
    outputText("<br><br>Content with how things turned out, you head back to camp and decide on the next course of action for today.");
    SandWitch.knockUpForce(); //Clear Pregnancy
    doNext(Camp.returnToCampUseOneHour);
};
