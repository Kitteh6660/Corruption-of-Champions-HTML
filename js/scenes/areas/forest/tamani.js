...
addToGameFlags(TAMANI_MET, TAMANI_TIME_OUT, TAMANI_BAD_ENDED, TAMANI_DAUGHTER_PREGGO_COUNTDOWN, TAMANI_NUMBER_OF_DAUGHTERS, TAMANI_TIMES_HYPNOTIZED, TAMANI_DEFEAT_COUNTER, TAMANI_TIMES_IMPREGNATED, TAMANI_PREGNANCY_COUNT, TIMES_OVIPOSITED_TAMANI);
...
TamaniScene.tamaniVictoryMenu = function() {
    ...
    if (player.lust >= 33 && player.totalCocks() > 0 && gameFlags[SFW_MODE] <= 0) {
        ...
        outputText("<br><br>What do you do to her?");
        menu();
...
TamaniScene.tamaniSexWon = function() {
    ...
    if (player.cockArea(x) <= 90) {
        ...
        if (player.totalCocks() > 1) outputText("s", false);
        outputText(" clenching and squeezing around you quickly washes it away.<br><br>", false);
        ...
        if (player.totalCocks() == 1) outputText("pussy squeezing tightly as she cums hard.<br><br>", false);
        else outputText("holes squeezing tightly as she cums hard.<br><br>", false);
        ...
        outputText("<br><br>Tamani winks, sucking on her finger as she staggers up.  She coos, \"<i>Mmmm, Tamani loves it when her " + player.mf("sexy lover","stud") + " dominates her.  Do you think your ", false);
    ...
    //Too big? Jerk off with feet and bukkake
        ...
        outputText("has any more cream to give to me?</i>\"<br><br>", false);
...
TamaniScene.tamaniBeaten = function() {
    clearOutput();
    ...
    if (gameFlags[TIMES_OVIPOSITED_TAMANI] == 0) outputText("my baby-" + player.mf("daddy","momma"));
    ...
    if (gameFlags[TIMES_OVIPOSITED_TAMANI] > 0) outputText(", or in your case even more eggs");
    ...
    outputText("\n\n\"<i>W-wha... oooohhhh.  That's niiiicccce,</i>\" Tamani sighs while trying to meet your gaze.  You smirk mirthfully at her and reach down to play with her " + TamaniScene.tamaniChest() + ", squeezing and groping roughly while your eggs roll unimpeded into her willing, elastic womb.  The green girl shivers and moans, \"<i>Yes!  Fill me!  Fill me up!</i>\"");
...
TamaniScene.tamaniSexLost = function() {
    ...
    if (player.cocks[0].cockThickness >= 5) outputText("Impossibly, despite your titanic girth, the ring somehow expands to squeeze onto you, though it's painfully tight.<br><br>", false);
    else outputText("Somehow the ring fits onto you perfectly, as if it was made exactly for your " + player.cockDescript(0) + ", though it remains painfully tight.<br><br>", false);
    ...
    outputText(" and asks, \"<i>So are you sorry for making me wait for my cream " + player.mf("stud","slut") + "?  If you are, just say <b>I'm sorry mistress Tamani, please milk my cock whenever you want</b> and then beg me to cum.</i>\"<br><br>", false);
    ...
    if (player.cor < 50) outputText("  You have no choice, you'll say what she wants you to say.<br><br>", false);
    else outputText("  Being denied like this was kind of fun, but you REALLY need to get off now, so you'll say what she wants you to say.<br><br>", false);
    ...
    if (player.cor > 50) outputText("blushing hotly and doing your best to look like a submissive toy.<br><br>", false);
    else outputText("blushing in shame and embarrassment, but meaning every word.<br><br>", false);
...
TamaniScene.tamaniSexLetHer = function() {
    ...
    if (inCombat()) {
        ...
        if (player.isTaur()) {
            ...
            outputText("Tamani sidles up to you and pats your flank, cooing, \"<i>There there horsey, everything's going to be okay.  Momma Tamani's going to take really good care of you.</i>\"  Before you know it your " + player.armor.equipmentName + " is on the ground and the goblin is underneath you, climbing up to your crotch.<br><br>", false);
        }
        //Not taur
        else {
            ...
            outputText("  She wiggles her " + TamaniScene.tamaniChest() + ", and despite your efforts to control your body, ", false);
            if (player.cockTotal() == 1) outputText("an erection emerges", false);
            else outputText("erections sprout up like weeds", false);
            outputText(".  She strips you down, giving you a smirk as she says, \"<i>Just lie there and I'll take what I need, babe.</i>\"<br><br>", false);
        }
    }
    //Voluntary submission
        ...
        //Taur
        if (player.isTaur()) {
            outputText("You meekly undress and ask Tamani how she would like to take you today.  She titters and slowly walks around you, taking her time, taking in your formidable bestial body and your " + player.multiCockDescriptLight() + ". \"<i>All this, for little ol' me,</i>\" she breathes. She sounds more tantalized than daunted. \"<i>Stand still for me, horsie,</i>\" she commands. Unable to see her any more behind your flank, you do as she says. You feel a pair of tiny hands on your back thigh and then a small but dense weight climbing steadily towards your groin. You bite back laughter at the ticklish sensation.<br><br>", false);
        }
        else {
    ...
    if (player.isTaur()) {
        ...
        //If >18 Inches
            ...
            if (player.balls == 0) outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics.<br><br>", false);
            else outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics, before the goblin in question drives all thoughts out of your head by beginning to mash her soft soles into your " + player.ballsDescriptLight() + ".<br><br>", false);
            ...
            outputText("\"<i>Go on then,</i>\" she breathes eventually. \"<i>I guess you've had enough. Cum for Mistress Tamani, " + player.mf("stud","slut") + ". Cover me from head to toe.</i>\" As she says this, she walks her hands down your belly, positions herself directly over your head, uses her own lubrication to rub her feet furiously down your " + player.cockDescript(0) + " and then, with one last evil giggle, sticks her tongue directly into your urethra.<br><br>", false);

            //Low cum:
            if (player.cumQ() < 1200) {
                outputText("With a ragged sigh, you reach your peak. Your first blast of jizz goes straight into Tamani's mouth, but you feel the goblin nimbly and hastily changing her position so that the very tip of your " + player.cockDescript(0) + " can feel her moist snatch. Being teased for so long makes the sensation incredible, and it feels like entire minutes go by whilst you stand there, sweat dripping off you as you cum over and over again until your cock is doing nothing but flexing mindlessly.<br><br>", false);
            ...
            //High cum:
                ...
                outputText("With a bellowing roar, you cum with mind blowing force. Your churning balls blast out a river of gooey fluid, the first glorious arc of which flies straight past your human front and paints the tree in front of you. Totally insensate, you can do nothing for entire minutes but stand there and cum, over and over again, sweat dripping off your frame, until the entire area underneath you is covered with your spooge.<br><br>", false);
        ...
        //(Noncombat end:
            ...
            player.orgasm(); //TODO Check Order
    ...
    //Not-taurs
        ...
        outputText("She gets down on all fours, crawling up your legs until her gloss-covered lips reach your " + player.multiCockDescriptLight() + ".   Warm wetness slides along your length as the gobbo-slut gets you slick and wet with her saliva.   It has quite the effect on you, turning your " + player.cockDescript(0) + " into a hard trembling pleasure-center.  You sigh, enjoying the attention but more than ready to release your pent-up sexual need into the willing girl.<br><br>", false);
        //(fits)
        if (player.cockArea(0) <= 90) {
            ...
            outputText("Moaning like a whore, she easily slips the rest of the way down, bottoming out her sopping-wet fuck-tunnel.<br><br>", false);
            ...
            else outputText("Your " + player.nippleDescript(0) + "s burn with pain as the goblin twists and pulls on them, abusing them.  Pleasure and pain mix together, overwhelming you, reducing your world to little more than the slap of genital against genital and the painful torture happening to your chest.<br><br>", false);
            outputText("Tamani plays your body like a fiddle, keeping you near the edge as she noisily orgasms over your shaft again and again.  You can tell she's starting to tire, so she gives you a kind look and begins to pick up the tempo.   She whispers softly, \"<i>Go ahead, cream my honeypot until I can barely walk.</i>\"<br><br>", false);
            ...
            outputText("<br><br>A sudden draft of cold air blows across your suddenly released member, making you shiver.   You look over at Tamani, watching your seed run down her thighs as she primps her hair and does a quick touch-up of her make-up.  She finishes up and blows you a kiss, bidding you farewell, \"<i>I'll be back for more if this one doesn't take", false);
            ...
            outputText("</i>\"<br><br>", false);
            //Combat end:
            if (inCombat()) { // TODO CHECK ORDER
        ...
        //(Doesnt fit)
            ...
            outputText(" a rough slap.  Whimpering, you still your rebellious hips and allow her to play you like the world's most sensitive fiddle.  Tamani pulls your " + player.cockHead() + " up and rocks herself against it, openly moaning as you dribble pre into her sopping gash.<br><br>", false);
            outputText("\"<i>Oooh, you're too big for little ol' me,</i>\" moans the goblin, easing back a bit, \"<i>but I have something that might make you cum just as hard.   I'll just make sure to catch all your cum with my cunny!</i>\"    She pulls out a hot-pink dildo and gives it a lick.  You watch in horror as a drop of thick fluid leaks from the tip.  No doubt Tamani intends for you to take take the entire thing in one way or another.<br><br>", false);
            ...
            outputText(", \"<i>let out all that hot sticky spunk for Mistress Tamani.</i>\"<br><br>", false);
            ...
            outputText("The dildo slips out of your abused " + player.assholeOrPussy() + " forgotten in the heat of your lovemaking, leaking pink goo.<br><br>", false);
            outputText("Tamani eases up off of you, dripping a mixture of sexual fluids and stretching as if she had just completed a long workout.  The slutty goblin winks at you and waves, \"<i>Thanks for the cum.  Be sure and take some time to refill.  I wanna be soaked again next time!</i>\"<br><br>", false);
...
TamaniScene.tamaniHypnosis = function() {
    //TODO TAMANI SPRITE spriteSelect(56);
    clearOutput();
    //Find a dick that fits
    var primary = player.cockThatFits(65);
    var secondary = 0;
    var cocks = player.totalCocks();

    outputText("Tamani crooks her finger and you come running, already feeling yourself straining against your " + player.armor.equipmentName + " for a chance to fuck your wife and mistress.  She giggles, \"<i>Ohhh, how sweet, you're so ready to do your duty.</i>\"<br><br>", false);

    outputText("The goblin traces her fingers over the bulge in your " + player.armor.equipmentName + " before reaching inside of it to give you a tender squeeze.  You sigh, happy to have earned such tender treatment from your lovely wife.  Automatically, your hands undo your " + player.armor.equipmentName + ", removing the troublesome garment so as not to interfere with your lovemaking.   Tamani gives you another squeeze and teases, \"<i>Oh baby, you're hooked on Tamani's pussy, aren't you?  I can tell, you're practically trembling.  Let Tamani help take care of that for you.</i>\"<br><br>", false);

    outputText("She smirks and bends over, looking back up at you from between her legs.  She offers, \"<i>Go ahead and stick it in.  A horny " + player.mf("boy","herm") + " like you needs to have that delicious cock inside a nice, tight wife like myself.</i>\"<br><br>", false);
    //[FITS]
    if (primary >= 0) {
        ...
        outputText("  You don't stop until your " + player.cockHead(primary) + " is the only thing inside her.<br><br>", false);
        ...
        outputText("  She visibly orgasms, shaking and trembling from head to toe as her pussy milks your " + player.cockDescript(primary) + ".  It only lasts a few seconds, though they feel like heaven, before her body goes nerveless.<br><br>", false);
        ...
        outputText("  Swelling wider inside the wet hole, your " + player.cockDescript(primary) + " tingles and clenches, about to unload.<br><br>", false);
    ...
    //[DOESNT FIT]
        ...
        outputText(player.mf("strong man's","sexy lover's") + " " + Appearance.cockNoun(CockTypesEnum.HUMAN) + "?</i>\"<br><br>", false);
        ...
        outputText(" her not to stop.  Tamani starts to giggle, but bursts into a moan as her fingers slide along her easily visible clit. She pants, \"<i>Hurry up and come for Tamani baby, I wanna feel you pumping your cum inside me!</i>\"<br><br>", false);
...
TamaniScene.tamaniFirstTimeConsentual = function() {
    ...
    TamaniScene.tamaniKnockUp();
    clearOutput();
    outputText("You almost can't believe your good fortune.  Finally you meet a creature willing to talk instead of just launching into violent rape.   Her direct advances were so crude and overtly sexual that you felt yourself stiffening before she could even finish her offer.   Your decision was made by the tent in your " + player.armor.equipmentName + ".  You'll give Tamani exactly what you both want.<br><br>", false);
    outputText("Her hips sway seductively as she approaches with her right hand dipping into the moist honeypot of her sex.  You disrobe, throwing your " + player.armor.equipmentName + " to the side before you reach down and lift her up, pressing her curvy body against your ", false);
    if (player.biggestTitSize() > 1) outputText(player.allBreastsDescript(), false);
    else outputText("chest", false);
    outputText(".  She wraps her tiny arms around your neck and kisses you passionately, letting her tongue slither through your lips.   The two of you french kiss hard, virtually tongue-fucking each other.<br><br>", false);
    outputText("She breaks the kiss and smiles, licking the shining purple lipstick she wears as she whispers in your ear, \"<i>Mmmhmm, I knew your juicy cock just couldn't resist a wet and ready pussy like mine.  I made sure to lace my lipstick with fertility enhancing chemicals too, so we'll be nice and messy.</i>\"<br><br>", false);
    ...
    outputText("  You NEED to fuck her pussy full – NOW.<br><br>", false);
    //(FITS)
    if (player.cockArea(0) <= 90) {
    ...
    //(TOO BIG)
        ...
        outputText(" as Tamani does her best to catch it in her mouth and soaked cunt.<br><br>", false);
...
TamaniScene.tamaniFirstTimeRefusal = function() {
    //TODO Tamani Sprite spriteSelect(56);
    clearOutput();
    outputText("Tamani's eyes widen in surprise, \"<i>Don't let the size fool you, big " + player.mf("boy", "girl") + ". I can take more than you think,</i>\" she says while her hands begins playing with her box, \"<i>Are you sure you don't want to just let off a little steam?</i>\"<br><br>", false);
...
TamaniScene.tamaniSecondRefusal = function() {
    //spriteSelect(56); TODO Tamani Sprite
    clearOutput();
    outputText("The goblin pouts, anger clouding her cute little features.  She turns and storms off, clearly pissed at you, \"<i>Think about it.  Next time that dick better ache for me, or I'll MAKE you want it.</i>\"<br><br>", false);
...
TamaniScene.tamaniKnockUp = function() {
    ...
    if (cum >= 300 && rand(2) == 0) gameFlags[TAMANI_PREGNANCY_COUNT]++;
    if (cum >= 400 && rand(2) == 0) gameFlags[TAMANI_PREGNANCY_COUNT]++;
    if (cum >= 500 && rand(2) == 0) gameFlags[TAMANI_PREGNANCY_COUNT]++;
    if (cum >= 600 && rand(2) == 0) gameFlags[TAMANI_PREGNANCY_COUNT]++;
};

TamaniScene.tamaniPregnantEncounter = function() {
    //TODO SPRITE spriteSelect(56);
    clearOutput();
    ...
    //[Fuck Her] [Refuse]
    addButton(0, "Fuck Her", TamaniScene.tamaniPregnantFuck);
    addButton(1, "Refuse", TamaniScene.tamaniPregnantRefusal);
};

TamaniScene.tamaniPregnantFuck= function() {
    //TODO Sprite spriteSelect(56);
    clearOutput();
    ...
    //(Doesn't Fit)
        ...
        gameFlags[TAMANI_NUMBER_OF_DAUGHTERS] += 3;
...
TamaniScene.tamaniPregnantRefusal = function() {
    //TODO SPrite spriteSelect(56);
    clearOutput();
...
TamaniScene.tamaniBirthScene = function() {
    ...
    if (gameFlags[TAMANI_NUMBER_OF_DAUGHTERS] > 0) outputText("with her daughters, ", false); //She always has at least two daughters if she has any
    outputText("laying against a scrubby tree with her legs spread wide and surrounded by a small puddle.  Her " + TamaniScene.tamaniChest() + " heave with deep breaths as she pushes hard, stretching her cunt wide.  Her eyes roll back as a green form slips free, revealing a tiny goblin that immediately stands up on wobbly legs.  The little girl turns and latches onto her mother's bloated nipple as another child slips free.", false);
    if (gameFlags[TAMANI_PREGNANCY_COUNT] > 2) {
        outputText("  Moments later a third appears", false);
        if (gameFlags[TAMANI_PREGNANCY_COUNT] > 3) {
            outputText(", a fourth", false);
            if (gameFlags[TAMANI_PREGNANCY_COUNT] == 5) {
    ...
    outputText("  She looks up at you and whispers breathily, \"<i>Come fuck me a little later, I'll give you even more beautiful little girls.  These " + num2Text(gameFlags[TAMANI_PREGNANCY_COUNT]) + " will be fully grown in a week or two and out man-hunting, but none of them will please you like me, I promise.</i>\"\n\n", false);
    ...
    player.changeLust((player.lib / 10) + (player.cor / 10));
    TamaniScene.tamaniGivesBirth(); //Clears pregnancies
    doNext(Camp.returnToCampUseOneHour);
};
