function Goblin() {
	...
	this.level = 1;
	this.XP = 11;
	this.gems = 6 + Math.random();
	
	//Sexual characteristics
	this.ass.analLooseness = ANAL_LOOSENESS_TIGHT;
	this.ass.analWetness = ANAL_WETNESS_DRY;
	
	this.combatAI = Goblin.doAI;
	//Victory/defeat
	this.victory = Goblin.victoryAgainstGoblin;
